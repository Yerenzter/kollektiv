...
<body>
    ...
    <div class="row p-3">
        <div class="col s12 m8">
            <h4 class="purple-text text-darken-2">Manage Authors</h4>
        </div>
        <div class="col s12 m4">
            <form action="/authors" method="post" class="row valign-wrapper">
                <div class="input-field outlined col s9">
                    <input type="search" name="author_search" id="author_search" placeholder="Search authors">
                </div>
                <div class="col s3">
