...
<html lang="en">
<?php
$title = "Kollektiv | Manage Students";
$description = "Manage students by creating or removing it in your system.";
...
<body>
    ...
    <div class="row p-3">
        <div class="col s12 m8">
            <h4 class="purple-text text-darken-2">Manage Students</h4>
        </div>
        <div class="col s12 m4">
            <form action="/courses" method="post" class="row valign-wrapper">
                <div class="input-field outlined col s9">
                    <input type="search" name="author_search" id="author_search" placeholder="Search students">
                </div>
                <div class="col s3">
